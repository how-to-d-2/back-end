...
//
//
//        User u1 = new User("test admin", "password", "email-1@howto.local");
...
//
//
//        User u2 = new User("test Anthony", "password", "email-2@howto.local");
...
//
//
//        User u3 = new User("test Peep", "password", "email-3@howto.local");
...
//
//
//        User u4 = new User("test Benjamin", "password", "email-4@howto.local");
